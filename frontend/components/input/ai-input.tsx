...
const CreativeCard: React.FC<CreativeCardProps> = ({ placeholder = "Type your creative idea here...✨", tags = ["Generate Image", "Analyze Data", "Explore More"] }) => {
  return (
      ...
      <div className="relative flex flex-col rounded-2xl p-[2px] overflow-hidden">
        ...
        <div className="flex flex-col dark:bg-black/50 bg-white/20 rounded-xl w-full overflow-hidden border border-gray-200 dark:border-gray-800">
          <div className="relative flex">
            <textarea id="chat_bot" name="chat_bot" placeholder={placeholder} className="bg-transparent rounded-xl w-full h-14 text-gray-900 dark:text-white font-sans text-sm font-medium p-3 resize-none outline-none placeholder-gray-600 dark:placeholder-gray-400 scrollbar-thin scrollbar-thumb-gray-500 dark:scrollbar-thumb-gray-700 scrollbar-thumb-rounded hover:scrollbar-thumb-gray-700 transition-all" />
          </div>
