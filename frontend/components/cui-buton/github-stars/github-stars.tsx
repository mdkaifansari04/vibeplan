...
import "../../../app/styles/github-stars.css";
...
export const GithubStarsButton = ({
  ...
  ComponentProps<"a">) => {
  return (
    <Link href={href} className={cn("group relative dark:bg-neutral-800 bg-neutral-200 rounded-full p-px", className)} {...props}>
      <span className="absolute inset-0 rounded-full overflow-hidden" style={{ transform: "translateZ(0)" }}>
        <span
      ...
      <span className="flex items-center justify-center gap-1 relative z-1 dark:bg-neutral-950/90 bg-neutral-50/90 rounded-full py-2 px-4 pl-2 w-full">
        <span className="relative  group-hover:scale-105 transition-transform group-hover:rotate-[360deg]">
          <CuicuiStarIcon
            ...
            style={{
              animation: "14s cubic-bezier(0.68, -0.55, 0.27, 1.55) infinite alternate star-rotate",
            }}
          />
          <span
