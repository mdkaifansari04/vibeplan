    ...
    <div className="pt-4 px-3 w-full">
      <div className="grid grid-cols-4 w-full gap-1">
        {sectionItems.map((section) => {
          ...
          //TODO Add Tooltips
          return (
            <Link href={section.href} key={section.title} className={cn("flex flex-col items-center p-[3px] text-center text-neutral-600 dark:text-neutral-300 hover:bg-neutral-500/20 transition rounded-[20px] relative")}>
              {isActive && (
                <div
              ...
              <div className={cn("px-3 py-4 bg-neutral-50 border dark:bg-neutral-900 size-full grid place-content-center rounded-[16px] relative z-10", isActive ? "border-none" : "dark:border-none border-neutral-200")}>
                {section.Icon}
