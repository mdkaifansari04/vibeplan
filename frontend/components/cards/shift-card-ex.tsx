...
function ShiftCardDemo() {
  ...
  const topAnimateContent = (
    <>
      <motion.img transition={{ duration: 0.3, ease: "circIn" }} src="/basic-img.png" layoutId="img" width={78} height={100} alt="basic image" className="rounded-sm  absolute top-1.5 right-2 shadow-lg" />
  ...
  const middleContent = <motion.img src="/basic-img.png" layoutId="img" width={150} height={200} alt="basic image" className="rounded-sm  border-2 border-white dark:border-black" />;
      ...
      <div className="flex w-full flex-col gap-1 bg-primary/90 border-t border-t-black/10 rounded-t-lg px-4 pb-4  ">
        ...
        <div className="bg-accent/80 dark:bg-accent px-1 py-1 rounded-xl flex flex-col gap-1">
          <TextureButton variant="primary">
            <svg viewBox="0 0 256 209" width="1em" height="1em" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
